...
public class WordProblemSolverTest {
    ...
    @Test
    public void testSingleExponentiation1() {
        assertEquals(32, solver.solve("What is 2 raised to the 5th power?"));
    }

    @Test
    public void testExponentiationFirstThenSubtraction() {
        assertEquals(-3, solver.solve("What is 2 raised to the 1st power minus 5?"));
    }

    @Test
    public void testMultiplicationThenExponentiationSecond() {
        assertEquals(36, solver.solve("What is 2 multiplied by 3 raised to the 2nd power?"));
    }
    ...
    @Test
    public void testSkipQuestionMark() {
        assertThatExceptionOfType(IllegalArgumentException.class)
                .isThrownBy(() -> solver.solve("2"))
                .withMessage("I'm sorry, I don't understand the question!");
    }
}
