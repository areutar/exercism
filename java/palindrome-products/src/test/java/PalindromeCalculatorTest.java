...
public class PalindromeCalculatorTest {
    ...
    public void smallestPalindromeFromSingleDigitFactors() {
        ...
        SortedMap<Long, List<List<Integer>>> palindromes =
                palindromeCalculator.getPalindromeProductsWithFactors(1, 9);
    ...
    public void largestPalindromeFromDoubleDigitFactors() {
        ...
        SortedMap<Long, List<List<Integer>>> palindromes =
                palindromeCalculator.getPalindromeProductsWithFactors(10,
                99);
    ...
    public void largestPalindromeFromTripleDigitFactors() {
        ...
        SortedMap<Long, List<List<Integer>>> palindromes =
                palindromeCalculator.getPalindromeProductsWithFactors(100,
                999);
    ...
    public void smallestPalindromeFromQuadDigitFactors() {
        ...
        SortedMap<Long, List<List<Integer>>> palindromes =
                palindromeCalculator.getPalindromeProductsWithFactors(1000,
                9999);
    ...
    public void emtpyResultSmallestNoPalindromeInRange() {
        ...
        SortedMap<Long, List<List<Integer>>> palindromes =
                palindromeCalculator.getPalindromeProductsWithFactors(1002,
                1003);
    ...
    public void emptyResultLargestNoPalindromeInRange() {
        ...
        SortedMap<Long, List<List<Integer>>> palindromes =
                palindromeCalculator.getPalindromeProductsWithFactors(15,
                15);
        assertTrue(palindromes.isEmpty());
    }
