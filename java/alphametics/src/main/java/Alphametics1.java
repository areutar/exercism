...
public class Alphametics1 {
    ...
    public Alphametics1(String equation) {
    ...
    public Map<Character, Integer> solve() throws UnsolvablePuzzleException {
        ...
        Supplier<String> perms = new PermutationsSupplier1("0123456789", letters.length);
...
class PermutationsSupplier1 implements Supplier<String> {
    ...
    public PermutationsSupplier1(String baseString) {
    ...
    public PermutationsSupplier1(String baseString, int n) {
