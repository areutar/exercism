...
public class WordCountTest {
    ...
    public void multipleSpacesNotDetectedAsAWord() {
        ...
        System.out.println(Arrays.toString(" multiple   whitespaces".split(" ")));
        System.out.println(Arrays.toString(" multiple   whitespaces".split("\\s+")));
        assertEquals(
                expectedWordCount, actualWordCount
        );
    }
    ...
    @Test
    public void usingSpecialSymbols() {
        expectedWordCount.put("o_ne", 1);
        expectedWordCount.put("two", 1);
        expectedWordCount.put("three", 1);
