...
public class TriangleTest {
    ...
    @Test
    public void triangleHaveDegenerativeSides() throws TriangleException {
        Triangle triangle = new Triangle(1, 1, 2);
        assertTrue(triangle.isDegenerative());
    }

    @Test
    public void triangleHaveNotDegenerativeSides() throws TriangleException {
        Triangle triangle = new Triangle(1, 2, 2.9);
        assertFalse(triangle.isDegenerative());
    }
}
