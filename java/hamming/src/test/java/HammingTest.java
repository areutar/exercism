...
public class HammingTest {
    ...
    @Test
    public void testValidatesLeftStrandIsNull() {
        ...
        assertThat(expected)
                .hasMessage("left strand must not be null.");
    }

    @Test
    public void testValidatesRightStrandIsNull() {
        NullPointerException expected =
                assertThrows(
                        NullPointerException.class,
                        () -> new Hamming("AAA", null));

        assertThat(expected)
                .hasMessage("right strand must not be null.");
    }
