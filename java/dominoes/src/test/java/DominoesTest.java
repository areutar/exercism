...
public class DominoesTest {
    ...
    @Test
    public void twoElementsSixTimesTest() throws ChainNotFoundException {
        Dominoes dominoes = new Dominoes();

        Domino[] dominoesArray = {new Domino(1, 2), new Domino(2, 1),
                new Domino(1, 2), new Domino(2, 1),
                new Domino(1, 1), new Domino(2, 2),
                new Domino(1, 1), new Domino(2, 2),
                new Domino(1, 1), new Domino(2, 2),
                new Domino(1, 2), new Domino(2, 1)};
        List<Domino> dominoesList = Arrays.asList(dominoesArray);
    ...
    @Test
    public void findPathTest() throws ChainNotFoundException {
        Dominoes dominoes = new Dominoes();
        Domino[] dominoesArray = {new Domino(1, 2), new Domino(2, 3), new Domino(3, 4),
                new Domino(4, 5), new Domino(5, 6), new Domino(6, 7),
                new Domino(7, 8), new Domino(8, 9), new Domino(9, 1)};
        List<Domino> dominoesList = Arrays.asList(dominoesArray);

//        System.out.println(dominoes.findPath(9, 7, dominoesList));
    }
