...
public class WordSearcherTest {
    ...
    public void testMy() {
        ...
        Map<String, Optional<WordLocation>> actualLocations = wordSearcher.search(
                searchWords,
                new char[][]{
                        {'j', 'e', 'f', 'b', 'l', 'p', 'e', 'p', 'r', 'e', '1', '2'},
                        {'c', 'a', 'm', 'd', 'c', 'i', 'm', 'g', 't', 'c', '1', '2'},
                        {'o', 'i', 'v', 'o', 'k', 'p', 'r', 'j', 's', 'm', '1', '2'},
                        {'p', 'b', 'w', 'a', 's', 'q', 'r', 'o', 'u', 'a', '1', '2'},
                        {'r', 'i', 'x', 'i', 'l', 'e', 'l', 'h', 'r', 's', '1', '2'},
                        {'w', 'o', 'l', 'c', 'q', 'l', 'i', 'r', 'p', 'c', '1', '2'},
                        {'s', 'c', 'r', 'e', 'e', 'a', 'u', 'm', 'g', 'r', '1', '2'},
                        {'a', 'l', 'x', 'h', 'p', 'b', 'u', 'r', 'y', 'i', '1', '2'},
                        {'j', 'a', 'l', 'a', 'y', 'c', 'a', 'l', 'm', 'p', '1', '2'},
                        {'c', 'l', 'o', 'j', 'u', 'r', 'e', 'r', 'm', 't', '1', '2'}});
