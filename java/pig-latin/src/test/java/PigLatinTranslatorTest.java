...
public class PigLatinTranslatorTest {
    ...
    @Test
    public void testThreeConsonantsAtTheBeginning() {
        assertEquals("emeschay", pigLatinTranslator.translate("scheme"));
    }

    @Test
    public void testTwoConsonantsWord() {
        assertEquals("ccay", pigLatinTranslator.translate("cc"));
    }
}
