...
public class RotationalCipherTest {
    ...
    @Test
    public void rotateSingleCharacterBy1Back() {
        rotationalCipher = new RotationalCipher(-1);
        Assert.assertEquals("z", rotationalCipher.rotate("a"));
    }
    ...
    @Test
    public void rotateSingleCharacterBy26Back() {
        rotationalCipher = new RotationalCipher(-26);
        Assert.assertEquals("a", rotationalCipher.rotate("a"));
    }
    ...
    @Test
    public void rotateSpacesBack() {
        rotationalCipher = new RotationalCipher(-5);
        Assert.assertEquals("J H B", rotationalCipher.rotate("O M G"));
    }
    ...
    @Test
    public void rotateNumbersBack() {
        rotationalCipher = new RotationalCipher(- 4);
        Assert.assertEquals("Paop 1 2 3 paop", rotationalCipher.rotate("Test 1 2 3 test"));
    }
